# TimeValidation - https://github.com/dmanusrex/TimeValidate
# Copyright (C) 2024 - Darren Richer
#
...
def git_semver(wrv: str) -> str:
    """
    Returns a legal semver description of the version
    identifier.
...
def is_latest_version(latest_version: Optional[ReleaseInfo], swonv: str) -> bool:
    """
